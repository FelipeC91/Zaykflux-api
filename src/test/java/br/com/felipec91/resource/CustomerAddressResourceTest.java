...
public class CustomerAddressResourceTest {
    ...
    public void givenNewContact_whenValid_saveIt(){
        var city = cityRepository.findByName("Osasco");
    ...
    @Test
    @Order(2)
    public void givenAnAddress_whenExists_editIt() {
        var existentCustomerId = customerRepository.findByTradingNameIgnoreCase("AÇAILAND")
                .get(0)
                .getId();
        ...
        var oldAddress = new Address("01000000",
                "Vl. Teste",
                "R. Teste",
                null,
                123,
    ...
    @Test
    @Order(3)
    public void givenAnAddress_whenExists_deleteIt() {
        var existentCustomerId = customerRepository.findByTradingNameIgnoreCase("AÇAILAND")
                .get(0)
                .getId();
        ...
        var contacts = customerRepository.findByTradingNameIgnoreCase("AÇAILAND").get(0).getAddresses();

        Assertions.assertFalse(contacts.contains(existentAddress));
