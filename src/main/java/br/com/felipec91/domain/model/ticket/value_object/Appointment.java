...
public class Appointment {
    ...
    private Appointment(LocalDate appointmentDate, OffsetTime beginningAt, OffsetTime endingAt, String description, Attendant accountable) {
    ...
    public static Appointment create(LocalDate appointmentDate, OffsetTime beginningAt, OffsetTime endingAt, String description, Attendant accountable) {
